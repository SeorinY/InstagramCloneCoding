...
//  Instagram
//
//  Created by Mac Book Pro on 2022/08/13.
//
...
class NotificationLikeEventTableViewCell: UITableViewCell {
    ...
    private let label : UILabel = {
        ...
        label.text = "@seorin liked your photo."
        return label
    }()
    ...
    override func layoutSubviews() {
        ...
        label.frame = CGRect(x: profileImageView.right+5, y: 0,
                             width: contentView.width-size-profileImageView.width-16, height: contentView.height)
    }
}
